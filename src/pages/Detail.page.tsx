...
const DetailPage: FC = () => {
  ...
  return (
    <div className="container">
      <h3 className="datos">{character.name}</h3>
      ...
      <p className="lista">Lista de episodios donde apareció el character</p>
      <div className={"episodes-grid"}>
        {status === "LOADING" ? (
          ...
          episodes.map((episode: Episode) => {
            return (
              <div className={"episodeText"} key={`episode_${episode.id}_${character.name}`}>
